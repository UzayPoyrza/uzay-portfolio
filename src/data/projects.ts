...
export const projects: Project[] = [
  {
    ...
    summary: "Volo is an app I built with active airline pilots to identify and address pain points in the cockpit. It automates 9+ pre-departure workflows, saving **~30 minutes per flight**. Today, Volo is actively used by 300+ pilots, with over 10% as paid subscribers.",
  ...
  },
  {
    ...
    description: "I started Neurotype after hearing Harvard-trained psychiatrist Dr. K talk about how different minds respond to different meditation techniques. For someone with ADHD, sound or movement-based meditation can be much more effective than a long body scan, but meditation apps still treat everyone the same. So I built one that doesn't. Neurotype uses AI to turn research across ADHD, anxiety, sleep, and more into full guided meditation and CBT sessions, then adapts recommendations based on what each user is responding to best.",
