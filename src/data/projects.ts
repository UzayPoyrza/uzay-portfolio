...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Incraft gives content creators and therapists human-like and highly scientifically accurate guided meditation and CBT sessions from a single prompt. Multi-stage LLM pipelines generate a custom session with pacing, structure, and safety constraints that are used in actual matching scientific papers. Multiple soundscapes intelligently ranked and matched according to session protocol and generated content. Voice and sound are audio engineered to deliver studio-quality audio, all in under two minutes. Additional dashboard and studio for fine-grained control over every layer.",
