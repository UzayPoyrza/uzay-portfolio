...
export const projects: Project[] = [
  {
    ...
    description: "I started Neurotype after hearing Harvard-trained psychiatrist Dr. K talk about how different minds respond to different meditation styles. Someone with ADHD may respond far better to sound, movement, or tighter structure than a long guided body scan - but most meditation apps still treat everyone the same. So I built one that doesn't. Neurotype uses AI to transform research across ADHD, anxiety, sleep, and more into complete guided meditation and CBT sessions, including narration, pacing, and sound design, then personalizes recommendations based on what each user responds to best.",
  ...
  },
  {
    ...
    description: "When I was 12, I had the chance to sit in a cockpit and noticed how many calculations pilots still did by hand. It became one of the first real problems I wanted to solve with software. Over the years, I built tools to automate those workflows; Volo brings them together in one app, adds the features pilots kept asking for, and saves about 15 minutes per flight. Built with Turkish Airlines pilots, partly through a self-hosted OpenClaw setup on WhatsApp.",
